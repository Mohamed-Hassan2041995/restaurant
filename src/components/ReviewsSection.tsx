  ...
  const reviews = [
    {
      ...
      review:
        "From the moment we walked in, the ambiance was perfect. The truffle risotto was a masterpiece, and the service was impeccable. This is fine dining at its absolute best.",
      date: "2 weeks ago",
      verified: true,
      avatar: "SC",
    },
    {
      ...
      review:
        "We celebrated our 10th anniversary here and it exceeded all expectations. The sommelier's wine pairing was brilliant, and every course was pure artistry on a plate.",
      date: "1 month ago",
      verified: true,
      avatar: "MR",
    },
    {
      ...
      review:
        "The attention to detail in every dish is remarkable. The chef's tasting menu was a journey through flavors I never knew existed. Worth every penny!",
      date: "3 weeks ago",
      verified: true,
      avatar: "ET",
    },
    {
      ...
      review:
        "Brought international clients here and they were thoroughly impressed. The private dining room, exceptional service, and exquisite food made for a perfect evening.",
      date: "1 week ago",
      verified: true,
      avatar: "JW",
    },
    {
      ...
      review:
        "Every element was perfect - from the warm greeting to the final dessert. The lobster thermidor was divine, and the chocolate lava cake was the perfect ending.",
      date: "4 days ago",
      verified: true,
      avatar: "LP",
    },
    {
      ...
      review:
        "This restaurant truly deserves its reputation. The creativity in each dish, combined with flawless execution, makes this a destination worth traveling for.",
      date: "5 days ago",
      verified: true,
      avatar: "DK",
    },
    ...
    <section className="py-20 lg:py-32 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex flex-wrap gap-4 items-center space-x-8 bg-card/50 backdrop-blur-sm rounded-2xl px-8 py-4 border border-border/50">
            ...
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-orange-600 rounded text-white flex items-center justify-center text-xs font-bold">
                T
              </div>
