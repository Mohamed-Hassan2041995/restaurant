        ...
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-elegant font-bold text-foreground mb-4">
              Stay Updated with
              <span className="text-luxury block">Culinary Experiences</span>
            </h2>
        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Where culinary artistry meets exceptional service. Experience fine dining that transcends the ordinary and creates lasting memories.
            </p>
          ...
          {/* Awards & Recognition */}
          <div>
            <h4 className="text-lg font-semibold text-foreground mb-6">Recognition</h4>
            <div className="space-y-4">
              <div className="flex items-center">
                <Award className="h-5 w-5 text-secondary mr-3" />
                <span className="text-muted-foreground">Michelin 5-Star Rating</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-muted-foreground">OpenTable Diners' Choice</span>
              </div>
              <div className="flex items-center">
                <Heart className="h-5 w-5 text-secondary mr-3" />
                <span className="text-muted-foreground">Wine Spectator Award</span>
              </div>
            </div>
