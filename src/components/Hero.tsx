...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-32 right-20 w-32 h-32 bg-accent/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-bronze/20 rounded-full blur-2xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-elegant font-bold text-card mb-6 leading-tight">
          ...
          <p className="text-xl md:text-2xl text-card/90 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
            Indulge in our masterfully crafted dishes, where every meal is a journey through sophisticated flavors and elegant presentation.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="rounded-full text-lg px-8 py-6 text-card border-card/30 hover:bg-card hover:text-primary group backdrop-blur-sm"
            >
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-card/70 text-sm uppercase tracking-wider">Years Experience</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-secondary mb-2">50+</div>
              <div className="text-card/70 text-sm uppercase tracking-wider">Signature Dishes</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-secondary mb-2">5★</div>
              <div className="text-card/70 text-sm uppercase tracking-wider">Michelin Rating</div>
            </div>
          </div>
        </div>
      </div>
