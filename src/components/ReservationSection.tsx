        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Thank you for choosing Bellissimo. We've sent a confirmation email to {formData.email} with all the details of your reservation.
            </p>
            ...
            <Button 
              ...
              onClick={() => {
                ...
                setFormData({
                  name: '', email: '', phone: '', guests: '', time: '', occasion: '', requests: ''
                });
                setDate(undefined);
              }}
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-primary font-medium text-sm uppercase tracking-wider">Reservations</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-elegant font-bold text-foreground mb-6">
            Reserve Your
            <span className="text-luxury block">Perfect Table</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Experience an unforgettable evening at Bellissimo. Book your table and let us create magical moments for you.
          </p>
        </div>
          ...
          <div className="space-y-8 animate-slide-in-right">
            ...
            <div className="glass rounded-3xl p-8">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Group Reservations</p>
            ...
            <div className="glass rounded-3xl p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Our reservation team is ready to help you plan the perfect dining experience.
              </p>
